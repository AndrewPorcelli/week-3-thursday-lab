...
function backgroundSayHelloButton() {
  //   sayHelloButton.style.backgroundColor = "black";
  //   sayHelloButton.style.color = "white"
  sayHelloButton.classList.add("button-hello");
}

sayHelloButton.addEventListener("mouseover", backgroundSayHelloButton);
...
function backgroundBack() {
  sayHelloButton.classList.remove("button-hello");
}

sayHelloButton.addEventListener("mouseout", backgroundBack);
...
const repeatMyParam = () => {
  ...
  axios.get(`http://localhost:3000/repeat/myparam`).then((res) => {
    console.log(res.data);
    const a = document.getElementById("repeat-text");
    a.style.display = "block";
    a.textContent = res.data;
  });
};
